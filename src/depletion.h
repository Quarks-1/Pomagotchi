...
constexpr unsigned long SUNLIGHT_DEPLETION_INTERVAL = 1000;     // 1 second in milliseconds
// constexpr unsigned long SUNLIGHT_DEPLETION_INTERVAL = 7200000;  // 2 hours in milliseconds (commented out for now)
constexpr unsigned long THIRST_DEPLETION_INTERVAL = 500;        // 500ms for thirst
